...
homeCodePath=r"/Users/robfisch/lib/tomcat-processing/processing_final_version"
...
baseFolder = r"/Users/robfisch/share/RawData/Dep305/Robert_Fischer/Robert_TOMCAT_2"
...
targetFolder = os.path.join(baseFolder,sample,''.join(["04_prereg_segmented",leg])) 
...
for timestep in timestepnames:
	...
	segmentator.loadClassifier(r"/Users/robfisch/share/users/firo/11_Essential_Data/03_TOMCAT/11_thin_interlaces/R_m4_33_050_2/weka/classifier/leg_0_slice_400_time_series_spatial_dry_200time_leg_2_refine.model")	
	print('model loaded')
