...
sourceFolder = os.path.join(drive, 'Robert_TOMCAT_4_netcdf4_split_v2_no_pore_size_lim')
...
for sample in samples:
    ...
    k1 = knots[name][0]
    k2 = knots[name][1]   
    filename = os.path.join(sourceFolder, ''.join(['knot_energy_data_v3_1_', name, '.nc']))
